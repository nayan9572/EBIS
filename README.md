...
- **`EBIS_PROJECT_MANIFEST.md`** — Long-term project vision and guiding principles.
- **`EBIS_IMPLEMENTATION_CONTEXT.md`** — Architectural context and implementation rules.
- **`DIFC_IMPLEMENTATION_LOG.md`** — Evolution of the DIFC reasoning framework.
- **`FUEL_INTEGRATION_STATUS.md`** — Summary of the completed fuel integration phase.
- Additional design, governance, audit, and research documents located throughout the repository.
